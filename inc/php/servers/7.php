...
echo "<div class='container' align='center' style='padding-top:20px'>";
	...
	else
	{
		echo "<div class='servercontainer'>";
		echo "<p class='server'>";
		echo "<b>Servername:</b> " . $BC2Conn_7->getServerName() . "<img src='inc/img/maps/bc2/".$BC2Conn_7->getCurrentMap().".png' border='0' widht='100' height='73' style='float:right;padding-right:20px'></img><br />";
