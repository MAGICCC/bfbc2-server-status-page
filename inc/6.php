...
echo "<div class='container' align='center' style='padding-top:20px'>";
	...
	else
	{
		echo "<div class='servercontainer'>";
		echo "<p class='server'>";
		echo "<b>Servername:</b> " . $BC2Conn_6->getServerName() . "<img src='images/maps/bc2/".$BC2Conn_6->getCurrentMap().".png' border='0' widht='100' height='73' style='float:right;padding-right:20px'></img><br />";
